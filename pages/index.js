...
export default function Home() {
   ...
   if (loadingSate === "loaded" && !nfts.lenght)
               ...
               {nfts.map((nft, i) => (
                  <div key={i} className="border shadow rounded-xl overflow-hidden">
                     ...
                     <div className="p-4 bg-black">
                        <p className="text-2xl mb-4 fond-bold text-white">{nft.price} ETH</p>
                        <button
                           className="w-full bg-pink-400 text-white fond-bold py-2 px-12 rounded"
                           onClick={() => buyNft(nft)}
                        >
                           Buy
                        </button>
